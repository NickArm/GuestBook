...
<h3 align="center">guestBook</h3>
  ...
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://github.com/NickArm/GuestBook/issues">Report Bug</a>
    ·
    <a href="https://github.com/NickArm/GuestBook/pulls">Request Feature</a>
  </p>
</div>
...
The software elevates concierge services for hospitality businesses by offering a custom and multilingual guide that exceeds the usual standards, all without the necessity for app downloads.

Here's why:
* Create easily a guide for your apartment/hotel. Inform your guests for anything should know about your house
...
1. Clone the repo
   ```sh
   git clone https://github.com/NickArm/GuestBook/
   ```
...
Project Link: https://github.com/NickArm/GuestBook/
