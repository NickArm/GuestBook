            ...
            <div class="card-body pt-5">
                <form action="{{ route('service.update', ['service' => $service->id]) }}" method="post"
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <textarea class="form-control form-control-solid" name="property_service_description">{{ $service->description }}</textarea>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <input id="save_service" type="submit" class="btn btn-primary" value="Save Service">
                </form>
            </div>
            <!-- jQuery -->
