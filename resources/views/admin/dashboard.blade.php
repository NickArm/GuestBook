                ...
                <div class="modal fade" id="kt_modal_add_user" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                <!--begin::Form-->
                                <form id="kt_modal_add_user_form" class="form" action="{{ route('admin.addUser') }}"
                                    method="post">
                                    @csrf
                                    <!--begin::Scroll-->
                                            ...
                                            <div class="d-flex fv-row">
                                                ...
                                                <div class="form-check form-check-custom form-check-solid">
                                                    ...
                                                    <label class="form-check-label" for="kt_modal_update_role_option_0">
                                                        ...
                                                        <div class="text-gray-600">Administrator of the System</div>
                                                    </label>
                                                    <!--end::Label-->
                                                </div>
                                                <!--end::Radio-->
                                            ...
                                            <div class="d-flex fv-row">
                                                ...
                                                <div class="form-check form-check-custom form-check-solid">
                                                    ...
                                                    <label class="form-check-label" for="kt_modal_update_role_option_1">
                                                        <div class="fw-bold text-gray-800">Owner</div>
                                                        <div class="text-gray-600">Owner of A Property</div>
                                                    </label>
                                                    <!--end::Label-->
                                                </div>
                                                <!--end::Radio-->
