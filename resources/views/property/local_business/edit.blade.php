    ...
    <div class="container">
        ...
        <div class="card card-flush h-lg-100">
            ...
            <div class="card-body pt-5">
                <form
                    action="{{ route('local-business.update', ['property' => $property->id, 'localBusiness' => $localBusiness->id]) }}"
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <input type="text" class="form-control form-control-solid" name="title"
                            placeholder="Business Name" value="{{ $localBusiness->title }}" required>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                                ...
                                <select id="category_id" class="form-select form-select-solid lh-1 py-3" name="category_id"
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}"
                                            {{ $localBusiness->category_id == $category->id ? 'selected' : '' }}>
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <textarea name="description" class="form-control form-control-solid" rows="5" cols="40" required>{{ $localBusiness->description }}</textarea>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <input type="url" class="form-control form-control-solid" name="google_map"
                            value="{{ $localBusiness->google_map }}">
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <input type="url" class="form-control form-control-solid" name="directions_url"
                            value="{{ $localBusiness->directions_url }}">
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <input type="url" class="form-control form-control-solid" name="external_url"
                            value="{{ $localBusiness->external_url }}">
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div>
                        ...
                        <button type="submit" class="btn btn-primary">Update Local Business</button>
                    </div>
                </form>
            </div>
        </div>
